...
| Tab | What it holds |
| --- | --- |
| 🏠 Today | App name and greeting across the top, then a half-circle gauge with three nested arcs (steps, calories, heart points) against their daily goals, then water beside its add buttons, one box holding distance, move minutes, BMI and wellbeing, and a box-breathing timer |
...
The Today gauge carries three arcs: steps yellow, calories red, heart points green.
